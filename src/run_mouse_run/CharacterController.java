...
public abstract class CharacterController
{
    ...
    public CharacterController(String name, Position initialPosition, ArrayList<Tile> invisibleTiles)
    {
        ...
        map = GameManager.gameManager.getLevelGenerator().getViewedMap(String.format("%s Map", name), position, viewDistance, seeBehindWalls, invisibleTiles);
        viewedMap = map.copy();
    ...
    {
        viewedMap = GameManager.gameManager.getLevelGenerator().getViewedMap(name, position, viewDistance, seeBehindWalls, invisibleTiles);
